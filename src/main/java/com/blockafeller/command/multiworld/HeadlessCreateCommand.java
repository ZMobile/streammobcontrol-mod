...
import me.isaiah.multiworld.fabric.FabricWorldCreator;
...
public class HeadlessCreateCommand {

    public static int run(MinecraftServer mc, String[] args) {
        Identifier dim = null;
        Random r = new Random();
        long seed = r.nextInt();
        ...
        HeadlessMultiworldMod.setICreator(new FabricWorldCreator());
        HeadlessMultiworldMod.on_server_started(mc);
        ServerWorld world = HeadlessMultiworldMod.create_world(arg1, dim, gen, Difficulty.NORMAL, seed);
